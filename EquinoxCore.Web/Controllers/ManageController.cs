...
using EquinoxCore.Infra.CrossCutting.Identity.Extensions;
using EquinoxCore.Infra.CrossCutting.Identity.Models;
using EquinoxCore.Infra.CrossCutting.Identity.Models.ManageViewModels;
using EquinoxCore.Infra.CrossCutting.Identity.Services;
using EquinoxCore.Web.Extensions;
...
namespace EquinoxCore.UI.Web.Controllers
{
    [Authorize]
    public class ManageController : Controller
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("EquinoxCore Project"),
